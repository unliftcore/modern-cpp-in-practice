...
> **Prerequisites:** You should be comfortable with the data layout and container selection material from Chapter 10. Familiarity with basic computer architecture — cache hierarchies, virtual memory pages, branch prediction — is helpful but not required; this chapter introduces those concepts at the level needed for cost reasoning. Chapter 12 covers measurement in depth; this chapter focuses on building the mental model that tells you *what* to measure and *why*.
...
## 11.2 Naive and Legacy Approaches

### 11.2.1 Optimization by folklore
...
### 11.2.2 Premature micro-optimization
...
### 11.2.3 Treating the profiler as an oracle
...
### 11.3.1 The Memory Hierarchy as a Cost Table
...
### 11.3.3 Indirection and Pointer-Chasing
...
### 11.3.5 Branch Behavior and Representation Choices
...
### 11.3.6 The `pmr` Allocator Model
...
### 11.3.7 Putting the Model Together
...
## 11.4 Tradeoffs and Boundaries

### 11.4.1 Arena allocators are not universally better
...
### 11.4.2 Contiguous layout is not always faster
...
### 11.4.3 Small-buffer optimization has a size cost
...
### 11.4.4 Abstractions have real costs — and real benefits
...
### 11.4.5 Thread-local allocation changes the tradeoff
...
## 11.5 Testing and Tooling Implications

### 11.5.1 Allocation-aware testing
...
### 11.5.3 Compiler Explorer for cost intuition
...
### 11.5.4 `perf` and hardware counters
